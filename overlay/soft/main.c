...
/* Shared GUI entry for soft-framebuffer overlays (SDL / Wayland / fbdev / wasm). */
#include "editor.h"
#include "common.h"
#include "config.h"
#include "theme.h"
...
static void usage(void) {
  fprintf(stderr,
          "usage: %s [-h|-v|-H|-g WxH] [file ...]  (max %d docs)\n"
...
int main(int argc, char **argv) {
  ...
  /* Open help after files so demos/screenshots see the overlay. */
